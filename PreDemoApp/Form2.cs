...
namespace PreDemoApp
{
    public partial class Form2 : Form
    {
        ...
        public Form2(UserControl1 usc, Form1 f1)
        {
            ...
            this.f1 = f1;
            comboBox1.Items.AddRange(new object[] { "INSERT", "UPDATE", "DELETE" });
            AllBlock();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboBox1.SelectedIndex == 0)
            {
                ...
                {
                    DBConnection.sqlToDbWithChanges($"INSERT INTO predem(title, producttypeid, articlenumber, description, image, productionpersoncount, productionworkshopnumber, mincostforagent) VALUES ('{textBox2.Text}', '{textBox3.Text}', '{textBox4.Text}', '{textBox5.Text}', '{textBox6.Text}', '{textBox7.Text}', '{textBox8.Text}', '{textBox9.Text}');");
                    this.Close();
                }
            }
            if (comboBox1.SelectedIndex == 1)
            {
                ...
                {
                    DBConnection.sqlToDbWithChanges($"UPDATE predem SETtitle='{textBox2.Text}', producttypeid={textBox3.Text}, articlenumber='{textBox4.Text}', description='{textBox5.Text}', image='{textBox6.Text}', productionpersoncount={textBox7.Text}, productionworkshopnumber={textBox8.Text}, mincostforagent={textBox9.Text} WHERE id = {textBox1.Text};");
                    this.Close();
                }
            ...
            if (comboBox1.SelectedIndex == 2)
            {
                ...
                {
                    DBConnection.sqlToDbWithChanges($"DELETE FROM ppredem WHERE id = {textBox1.Text};");
                    this.Close();
                }
            }
        }
